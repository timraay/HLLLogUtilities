...
class TextConverter(Converter):
    ...
    player_score_updated    = "PLAYER SCORE        \t{player_name} ({player_steamid}): {player_score_combat} C, {player_score_offense} O, {player_score_defense} D, {player_score_support} S (KD: {new}/{message})"
