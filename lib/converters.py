...
class TextConverter(Converter):
    ...
    player_death            = "KILL                \t{player2_name} ({player2_team}/{player2_steamid}) -> {player_name} ({player_team}/{player_steamid}) with {weapon}"
    player_teamkill         = "TEAM KILL           \t{player2_name} ({player2_team}/{player2_steamid}) -> {player_name} ({player_team}/{player_steamid}) with {weapon}"
